...
describe "reports/search_shift_totals.html.haml" do
  ...
  it "displays a label and text field for the start_date" do
    should have_selector("form label", :for => "logical_shift_totals_report_start_date",
      :content => "From")
    should have_selector("form input", :name => "logical_shift_totals_report[start_date]")
  end

  it "displays a label and text field for the end_date" do
    should have_selector("form label", :for => "logical_shift_totals_report_end_date",
      :content => "To")
    should have_selector("form input", :name => "logical_shift_totals_report[end_date]")
  end

  it "displays a fieldset and check boxes for selecting shifts" do
    should have_selector("form fieldset legend", :content => "Shifts")
    should have_selector("form input", :name => "logical_shift_totals_report[shift_ids][]",
      :value => "#{mock_shift.id}")
  end
